...
<body style="background-image:url(images/45.jpg);">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				<h2 align="center" style="color:#;">Interior Design - Order Request From Clients</h2>
			...
			<table class="table table-striped table-hover table-bordered">
				...
				<tbody>
					<?php 
						$userid = $_SESSION["uid"];
						$results = mysqli_query($con,"select * from cart where Status='No' group by ClientId");
						while ($row=mysqli_fetch_array($results))
						{
							...
							<tr>
								...
								<td><a href="orders_view.php?clid=<?php echo $row['ClientId']; ?>"><?php echo $row['ClientId']; ?></a></td>
